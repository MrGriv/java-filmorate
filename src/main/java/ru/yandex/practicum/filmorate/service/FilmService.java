...
import ru.yandex.practicum.filmorate.dao.FilmGenresStorage;
...
public class FilmService {
    ...
    public Film create(Film film) {
        ...
        Film insertedFilm = filmStorage.addFilm(film);
        filmGenresStorage.setFilmGenres(insertedFilm);
    ...
    private Collection<Film> addGenreAndRating(Collection<Film> films) {
        ...
        Map<Integer, List<Integer>> filmsGenres = filmGenresStorage.getGenresOfFilmsById(films);
